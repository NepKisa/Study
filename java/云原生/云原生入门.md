...
spec:
  ...
  terminal:
    timeout: 600
status:
  clusterId: 9688d2f8-233a-4dd3-8c85-a8782d32e631-1717003226
  core:
    enabledTime: '2024-05-31T23:00:24CST'
    status: enabled
    version: v3.4.1
  events:
    enabledTime: '2024-05-31T01:34:29CST'
    ruler:
      enabledTime: '2024-05-31T01:34:29CST'
      status: enabled
    status: enabled
  fluentbit:
    enabledTime: '2024-05-31T01:33:54CST'
    status: enabled
  logging:
    enabledTime: '2024-05-31T01:34:27CST'
    status: enabled
  metricsServer:
    enabledTime: '2024-05-31T01:33:33CST'
    status: enabled
  minio:
    enabledTime: '2024-05-30T21:51:52CST'
    status: enabled
  monitoring:
    enabledTime: '2024-05-31T23:00:47CST'
    status: enabled
  opensearch:
    enabledTime: '2024-05-31T01:33:48CST'
    status: enabled
```
...
![img](../../images/image-1679984300944.png)
...
![image-20230328142141997](../../images/image-20230328142141997.png)

![image-20230328142155061](../../images/image-20230328142155061.png)

![image-20230328142308546](../../images/image-20230328142308546.png)

![image-20230328142318308](../../images/image-20230328142318308.png)

![image-20230328142415082](../../images/image-20230328142415082.png)

![image-20230328142813700](../../images/image-20230328142813700.png)

![image-20230328142842843](../../images/image-20230328142842843.png)

![image-20230328142959042](../../images/image-20230328142959042.png)

![image-20230328143010488](../../images/image-20230328143010488.png)

![image-20230328143023531](../../images/image-20230328143023531.png)

![image-20230328143124763](../../images/image-20230328143124763.png)

![image-20230328143227869](../../images/image-20230328143227869.png)

**点击下一步、按需修改配置后直接部署**

![image-20230328143246726](../../images/image-20230328143246726.png)
